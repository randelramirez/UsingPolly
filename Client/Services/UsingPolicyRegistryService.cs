...
namespace Client.Services
{
    public class UsingPolicyRegistryService : IService
    {
        ...
        public async Task WaitAndRetry()
        {
            ...
            IAsyncPolicy<HttpResponseMessage> retryPolicy = this.policyRegistry.Get<IAsyncPolicy<HttpResponseMessage>>("SimpleHttpWaitAndRetry");
            var response = await retryPolicy.ExecuteAsync(() => GetData());
